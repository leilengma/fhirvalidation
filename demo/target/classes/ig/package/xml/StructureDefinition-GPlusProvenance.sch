...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:title>f:Provenance/f:meta/f:tag</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:Provenance/f:agent/f:type/f:coding</sch:title>
    <sch:rule context="f:Provenance/f:agent/f:type/f:coding">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
